...
RESPONSES_DIR = BASE_DIR / "responses" / "curated"
SCORES_DIR = BASE_DIR / "scores" / "raw"
...
def build_benchmark():
    ...
    # Sauvegarde du benchmark complet
    out_path = BENCHMARK_DIR / "CATAR-Benchmark-v1.json"
    with open(out_path, "w", encoding="utf-8") as f:
        json.dump(benchmark, f, indent=4, ensure_ascii=False)

    print(f"✔ Benchmark généré : {out_path.name}")
